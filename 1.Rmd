...
GA_Ackley_2_stats <- round(c(mean_GA_Ackley_2,median_GA_Ackley_2), 2)
...
PRS_Ackley_2_stats <- round(c(mean_PRS_Ackley_2,median_PRS_Ackley_2), 2)
...
GA_Ackley_10_stats <- round(c(mean_GA_Ackley_10,median_GA_Ackley_10), 2)
...
PRS_Ackley_10_stats <- round(c(mean_PRS_Ackley_10,median_PRS_Ackley_10), 2)
...
GA_Ackley_20_stats <- round(c(mean_GA_Ackley_20,median_GA_Ackley_20), 2)
...
PRS_Ackley_20_stats <- round(c(mean_PRS_Ackley_20,median_PRS_Ackley_20),2 )
...
Średnia minimów znaleznionych przez algorytm genetyczny przy 2 wymiarach jest ok `r round(mean_PRS_Ackley_2/mean_GA_Ackley_2, 0)` razy mniejsza od tej wyznaczonej Poszukiwaniem przypadkowym.<br>
W kolejnych wymiarach odpowiednio `r round(mean_PRS_Ackley_10/mean_GA_Ackley_10, 0)` razy większa i `r round(mean_PRS_Ackley_20/mean_GA_Ackley_20, 1)` raza większa.
...
GA_Rosenbrock_2_stats <- round(c(mean_GA_Rosenbrock_2,median_GA_Rosenbrock_2), 2)
...
PRS_Rosenbrock_2_stats <- round(c(mean_PRS_Rosenbrock_2,median_PRS_Rosenbrock_2), 2)
...
GA_Rosenbrock_10_stats <- round(c(mean_GA_Rosenbrock_10,median_GA_Rosenbrock_10), 2)
...
PRS_Rosenbrock_10_stats <- round(c(mean_PRS_Rosenbrock_10,median_PRS_Rosenbrock_10), 2)
...
GA_Rosenbrock_20_stats <- round(c(mean_GA_Rosenbrock_20,median_GA_Rosenbrock_20), 2)
...
PRS_Rosenbrock_20_stats <- round(c(mean_PRS_Rosenbrock_20,median_PRS_Rosenbrock_20), 2)
...
średnie minimum dla GA ~ `r format(mean_GA_Rosenbrock_2, digits = 2)` <br>
średnie minimum dla PRS ~ `r format(mean_PRS_Rosenbrock_2, digits = 2)` <br>
Przy tych wynikach należy jednak spojrzeć na mediane, która w przypadku GA jest `r round(mean_GA_Rosenbrock_2/median_GA_Rosenbrock_2, 0)` razy mniejsza niż jego średnia. Może to świadczyć o dużym rozproszeniu wyników oraz występowaniu elementów odstających.<br>
