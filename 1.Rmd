...
```{r mean hist}
  names_Ackley <- c("GA_Ackley_2", "GA_Ackley_10", "GA_Ackley_20", "PRS_Ackley_2", "PRS_Ackley_10", "PRS_Ackley_20")
  df_Ackley <- data.frame("mean"=c(mean_GA_Ackley_2, mean_GA_Ackley_10, mean_GA_Ackley_20, mean_PRS_Ackley_2, mean_PRS_Ackley_10, mean_PRS_Ackley_20), "names"=names_Ackley, "algorithm"=c(replicate(3, "GA"),replicate(3, "PRS")))
...
ggplot(df_Ackley,                                      
  ...
  theme(axis.title.x=element_blank(),
        axis.ticks.x=element_blank())+ggtitle("Średnie minima funkcji Ackley") +
...
```{r mean plot rosenbrock}
  ...
  names_Rosenbrock <- c("GA_Rosen_2", "GA_Rosen_10", "GA_Rosen_20", "PRS_Rosen_2", "PRS_Rosen_10", "PRS_Rosen_20")
...
ggplot(df_Rosenbrock,                                      
       aes(x = reorder(names, mean),
           y = mean,
           group = 1, color=algorithm)) +
  geom_point() + scale_y_continuous(trans=scales::pseudo_log_trans(base = 10))+
  theme(axis.title.x=element_blank(),
        axis.ticks.x=element_blank())+ggtitle("Średnie minima funkcji Rosenberg") +
  theme(plot.title = element_text(hjust = 0.5))
```
<br>
