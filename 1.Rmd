...
Na wykresie widzimy, że większość otrzymanych wartości skupia się w okół mediany.
...
tableData2 <- data.frame(
  ...
  interval = format(confs[seq_len(6) %% 2 == 0], scientific = F , digits = 2),
  interval2 = format(confs[seq_len(6) %% 2 == 1], scientific = F, digits = 2)
)
